...
pub fn default_unresolved() -> Vec<String> {
    vec![
        ...
        "HUPCL is cleared on the live fd after serialport open; a pre-open stty is not enough because a fresh USB-serial session restores kernel-default HUPCL".into(),
