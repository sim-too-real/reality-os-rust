...
pub fn default_unresolved() -> Vec<String> {
    vec![
        ...
        "first USB prepare fails closed if sysfs idVendor never appears; continuing used to bind a tty-name identity that missed when usb:vid:pid:devpath showed up".into(),
