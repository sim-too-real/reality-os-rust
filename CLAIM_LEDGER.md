...
| PATCHED recover/integrity latch `709a0793fcf5e1706b059c27f1ed5a8dba0ca1f1` | Same-process | ACTIVE | governor tests; LINUX PTY STATUS pending on Windows; REAL XL330 STATUS not measured; Run B `docs/metal/RUN_B_PATCHED_AUTHORITY.md` |
